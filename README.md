...
This module creates an aws api gateway account with cloudwatch rules & a VPC link.
...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://github.com/https://github.com/Callumccr/tf-mod-aws-api-gateway/releases).
...
File a Github [issue](https://github.com/Callumccr/tf-mod-aws-api-gateway/issues), or message us on [Slack][slack]
